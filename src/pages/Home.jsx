            ...
            <div className="main-container">
                ...
                <div className='home-content'>
                    ...
                    <div className="info-container">
                        ...
                        <div>
                            <h1>Modified MobileNet V2</h1>
                            <p className='info-text'>MobileNet is a convolutional neural network (CNN) model that is designed for efficient image classification on mobile devices. It uses depthwise separable convolutions to reduce computation and model size. The model consists of a series of convolutional layers followed by depthwise separable convolutional layers, which separate spatial and channel-wise operations. </p>
                    ...
                    <div className="info-container alternating">
                        ...
                        <div>
                            <h1>Modified ResNet50V2</h1>
                            <p className='info-text'>ResNet50V2 is a variant of the ResNet (Residual Network) model, which is a popular convolutional neural network (CNN) architecture for image classification. It was introduced as an improvement over the original ResNet model to further enhance its performance.</p>
