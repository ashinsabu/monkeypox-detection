  ...
  return (
    <div id="my-footer" className="footer">
      <div className="footer-container">
        ...
        <div className="footer-links-container">
          <a
            href="https://github.com/rohanthorat27/Monkeypox-Detection"
            target="__blank"
          >
            View Original Research Code
          </a>
          <a
            href="https://github.com/rohanthorat27/Monkeypox-Detection"
            target="__blank"
        ...
        <div className="footer-links-container">
          ...
          <span className="socials-flex">
            <a
              href="https://www.linkedin.com/in/ashin-sabu-1059a6175/"
              target="__blank"
            >
          ...
          <span className="socials-flex">
            <a
              href="https://www.linkedin.com/in/rohan-thorat-b1655a253/"
              target="__blank"
            >
              <img src={LinkedIn} alt="LinkedIn" />
            </a>
      ...
      <a
        href="https://github.com/ashinsabu/monkeypox-detection/"
        target="__blank"
      >
        View source code
      </a>
